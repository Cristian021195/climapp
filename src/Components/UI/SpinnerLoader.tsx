export const SpinnerLoader = ({color='#FF914D', width='1', height='1', extra_class="zoom-in"}) => {
    return (
      <svg xmlns="SVG namespace" style={{ margin: "auto" }} width={width+"rem"} height={height+"rem"} className={" "+extra_class} display="block" preserveAspectRatio="xMidYMid" viewBox="0 0 100 100">
